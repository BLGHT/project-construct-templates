variable "iso_checksum" {
  type    = string
  default = "sha256:a06609fef056eadb588c4455137f056f2ffb0542d1c1920515b02060c07fa988"
}
...
variable "iso_url" {
  type    = string
  default = "https://software-static.download.prss.microsoft.com/dbazure/888969d5-f34g-4e03-ac9d-1f9786c66749/22631.2428.231001-0608.23H2_NI_RELEASE_SVC_REFRESH_CLIENTENTERPRISEEVAL_OEMRET_x64FRE_de-de.iso"
}
...
variable "vm_name" {
  type    = string
  default = "win11-23h2-x64-de-enterprise-template"
}
...
locals {
  template_description = "Windows 11 23H2 Enterprise 64-bit (German) template built ${legacy_isotime("2006-01-02 03:04:05")} username:password => localuser:password"
}

source "proxmox-iso" "win11-23h2-x64-de-enterprise" {
...
build {
  sources = ["source.proxmox-iso.win11-23h2-x64-de-enterprise"]
