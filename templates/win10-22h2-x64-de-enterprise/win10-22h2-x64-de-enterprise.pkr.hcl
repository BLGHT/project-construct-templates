variable "iso_checksum" {
  type    = string
  default = "sha256:dafc6f67d061b1007b6def2a5d797ae2562bd2c7b4321e9e600261e9a7de8620"
}
...
variable "iso_url" {
  type    = string
  default = "https://software-static.download.prss.microsoft.com/dbazure/988969d5-f34g-4e03-ac9d-1f9786c66750/19045.2006.220908-0225.22h2_release_svc_refresh_CLIENTENTERPRISEEVAL_OEMRET_x64FRE_de-de.iso"
}
...
variable "vm_name" {
  type    = string
  default = "win10-22h2-x64-de-enterprise-template"
}
...
locals {
  template_description = "Windows 10 22H2 Enterprise 64-bit (German) template built ${legacy_isotime("2006-01-02 03:04:05")} username:password => localuser:password"
}

source "proxmox-iso" "win10-22h2-x64-de-enterprise" {
...
build {
  sources = ["source.proxmox-iso.win10-22h2-x64-de-enterprise"]
