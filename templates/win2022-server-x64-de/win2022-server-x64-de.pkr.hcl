variable "iso_checksum" {
  type    = string
  default = "sha256:02d8367ced8381869d2c49d8cbf2d81376d60f9ce385c1843a152089673779a7"
}
...
variable "iso_url" {
  type    = string
  default = "https://software-static.download.prss.microsoft.com/sg/download/888969d5-f34g-4e03-ac9d-1f9786c66749/SERVER_EVAL_x64FRE_de-de.iso"
}
...
variable "vm_name" {
  type    = string
  default = "win2022-server-x64-de-template"
}
...
locals {
  template_description = "Windows Server 2022 64-bit (German) template built ${legacy_isotime("2006-01-02 03:04:05")} username:password => localuser:password"
}

source "proxmox-iso" "win2022-server-x64-de" {
...
build {
  sources = ["source.proxmox-iso.win2022-server-x64-de"]
