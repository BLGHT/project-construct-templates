...
variable "vm_name" {
  type    = string
  default = "ubuntu-20.04.1-x64-de-server-template"
}
...
locals {
  template_description = "Ubuntu 20.04 Server (German) template built ${legacy_isotime("2006-01-02 03:04:05")} username:password => localuser:password"
}
