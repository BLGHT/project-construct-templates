variable "iso_checksum" {
  type    = string
  default = "sha256:313c6f25891c53f804e5676ac1122c17bda15e290bce3c43773cd16007c3aac5"
}
...
variable "iso_url" {
  type    = string
  default = "https://software-static.download.prss.microsoft.com/dbazure/988969d5-f34g-4e03-ac9d-1f9786c66751/22621.525.220925-0207.ni_release_svc_refresh_CLIENTENTERPRISEEVAL_OEMRET_x64FRE_de-de.iso"
}
...
variable "vm_name" {
  type    = string
  default = "win11-22h2-x64-de-enterprise-template"
}
...
locals {
  template_description = "Windows 11 22H2 Enterprise 64-bit (German) template built ${legacy_isotime("2006-01-02 03:04:05")} username:password => localuser:password"
}

source "proxmox-iso" "win11-22h2-x64-de-enterprise" {
...
build {
  sources = ["source.proxmox-iso.win11-22h2-x64-de-enterprise"]
