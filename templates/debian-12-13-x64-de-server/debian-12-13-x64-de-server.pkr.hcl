...
variable "vm_name" {
  type    = string
  default = "debian-12-13-x64-de-server-template"
}
...
locals {
  template_description = "Debian 12 (German) template built ${legacy_isotime("2006-01-02 03:04:05")} username:password => debian:debian"
}
