variable "iso_checksum" {
  type    = string
  default = "sha256:3c2d6be3e98eb304b1eca6b319e0b6a78aeda01af7f3252d9d006a498d7ef214"
}
...
variable "iso_url" {
  type    = string
  default = "https://software-download.microsoft.com/download/pr/17763.737.190906-2324.rs5_release_svc_refresh_SERVER_EVAL_x64FRE_de-de_1.iso"
}
...
variable "vm_name" {
  type    = string
  default = "win2019-server-x64-de-no-security-updates-template"
}
...
locals {
  template_description = "Windows Server 2019 64-bit (German, no security updates) template built ${legacy_isotime("2006-01-02 03:04:05")} username:password => localuser:password"
}

source "proxmox-iso" "win2019-server-x64-de-no-security-updates" {
...
build {
  sources = ["source.proxmox-iso.win2019-server-x64-de-no-security-updates"]
