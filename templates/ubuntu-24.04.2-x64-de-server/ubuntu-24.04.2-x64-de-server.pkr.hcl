...
variable "vm_name" {
  type    = string
  default = "ubuntu-24.04.2-x64-de-server-template"
}
...
locals {
  template_description = "Ubuntu 24.04 Server (German) template built ${legacy_isotime("2006-01-02 03:04:05")} username:password => localuser:password"
}
