...
variable "vm_name" {
  type    = string
  default = "kali-2026-1-x64-de-desktop-template"
}
...
locals {
  template_description = "Kali Linux (German) template built ${legacy_isotime("2006-01-02 03:04:05")} username:password => kali:kali"
}
