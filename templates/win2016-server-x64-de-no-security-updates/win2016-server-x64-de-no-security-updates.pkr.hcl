variable "iso_checksum" {
  type    = string
  default = "sha256:3f0ee2b611f4600b236f7b10dbac6ba9766c52fb99b3eb9cf51a65ec72b1fc6d"
}
...
variable "iso_url" {
  type    = string
  default = "https://download.microsoft.com/download/7/E/B/7EBCA3A0-1F42-4966-B03E-713C3DEF98B7/14393.0.161119-1705.RS1_REFRESH_SERVER_EVAL_X64FRE_DE-DE.ISO"
}
...
variable "vm_name" {
  type    = string
  default = "win2016-server-x64-de-no-security-updates-template"
}
...
locals {
  template_description = "Windows Server 2016 64-bit (German, no security updates) template built ${legacy_isotime("2006-01-02 03:04:05")} username:password => localuser:password"
}

source "proxmox-iso" "win2016-server-x64-de-no-security-updates" {
...
build {
  sources = ["source.proxmox-iso.win2016-server-x64-de-no-security-updates"]
