variable "iso_checksum" {
  type    = string
  default = "sha256:82115b58c188847a79f70c3b46841c675d66c9fe259c8722e23ddf6197042624"
}
...
variable "iso_url" {
  type    = string
  default = "https://software-static.download.prss.microsoft.com/dbazure/988969d5-f34g-4e03-ac9d-1f9786c66749/17763.3650.221105-1748.rs5_release_svc_refresh_SERVER_EVAL_x64FRE_de-de.iso"
}
...
variable "vm_name" {
  type    = string
  default = "win2019-server-x64-de-template"
}
...
locals {
  template_description = "Windows Server 2019 64-bit (German) template built ${legacy_isotime("2006-01-02 03:04:05")} username:password => localuser:password"
}

source "proxmox-iso" "win2019-server-x64-de" {
...
build {
  sources = ["source.proxmox-iso.win2019-server-x64-de"]
