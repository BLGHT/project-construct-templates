variable "iso_checksum" {
  type    = string
  default = "sha256:b15884ea576c7b236e9617820128d10157ea272fae12895572600d1b70143a5a"
}
...
variable "iso_url" {
  type    = string
  default = "https://software-download.microsoft.com/download/sg/444969d5-f34g-4e03-ac9d-1f9786c69161/19044.1288.211006-0501.21h2_release_svc_refresh_CLIENTENTERPRISEEVAL_OEMRET_x64FRE_de-de.iso"
}
...
variable "vm_name" {
  type    = string
  default = "win10-21h2-x64-de-enterprise-template"
}
...
locals {
  template_description = "Windows 10 21H2 Enterprise 64-bit (German) template built ${legacy_isotime("2006-01-02 03:04:05")} username:password => localuser:password"
}

source "proxmox-iso" "win10-21h2-x64-de-enterprise" {
...
build {
  sources = ["source.proxmox-iso.win10-21h2-x64-de-enterprise"]
